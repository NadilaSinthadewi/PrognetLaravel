...
<body style="background-color: skyblue;">
  <div class="container mt-4">
    <div class="card">
      ...
      <div class="card-body">
        <form name="formBiodata" action="/mahasiswaa" method="post" onsubmit="return validateForm()">
          @csrf
          ...
          <div class="form-group mb-3">
            ...
            <input type text="text" name="nickname" id="nickname" placeholder="Nama Panggilan" class="form-control">
          </div>
          <div>
          ...
          <div>
            ...
            <button class="badge bg-primary border-0 mb-2" type="submit">Submit</button>
            </form>
